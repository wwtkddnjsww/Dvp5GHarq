...
```
cd existing_repo
git remote add origin https://code.siemens.com/sangwon.bpi/5g-urllc-simulation.git
git branch -M main
...
- [ ] [Set up project integrations](https://code.siemens.com/sangwon.bpi/5g-urllc-simulation/-/settings/integrations)
