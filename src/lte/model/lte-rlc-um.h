...
class LteRlcUm : public LteRlc
{
  ...
  private:
    ...
    uint32_t m_schedulingDiscardTimerMs; //!< the discard timer for scheduling.
    bool m_DiscardingRepetitionPacketInTheSameQueue;
    bool m_independent_queue{false};
    /**
     * Reassembling state
     */
