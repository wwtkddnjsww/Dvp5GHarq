...
class UeManager : public Object
{
    ...
    //this is added by Sangwon
    friend class NrMacSchedulerNs3;
  public:
    /**
...
class LteEnbRrc : public Object
{
    ...
    //changed by Sangwon; This class is used for packet duplication to access the variables
    friend class NrMacSchedulerNs3;
