...
main(int argc, char* argv[])
{
    ...
    uint32_t udpPacketSizeULL = 70; //orig 100
    ...
    Time simTime = MilliSeconds(3300000);//1600400= 1million simtime for 8ms case = 800 second. 2ms case = 200 second (160400)
    ...
    double totalTxPower = -6.5028; //orig 4, for single transmission -10dbm
    ...
    else
    {
        ...
        for (uint32_t kk = 0; kk <= ueNum/10; kk++){
            ...
            {
                uePositionAlloc->Add(Vector(20-k*1.0, 20-kk,ueHeight));
            }
        }
