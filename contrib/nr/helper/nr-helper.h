...
class NrHelper : public Object
{
  public:
    ...
    void SetSchedRrcConnectionEnabled(bool v);
    ...
    void SetUrllcUes(uint8_t urllcUes);
  ...
  private:
    ...
    Ptr<NrMacScheduler> CreateGnbSchedRrcConnected(Ptr<LteEnbRrc> rrc);
    ...
    bool m_urllcHarqEnabled{false};
    bool m_SchedRrcConnectionEnabled{false};
    bool m_snrTest{false};
    uint8_t m_urllcUes = 0;
