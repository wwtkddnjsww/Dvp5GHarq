...
std::ofstream NrPhyRxTrace::m_ulrxPacketTraceFile;
std::string NrPhyRxTrace::m_ulrxPacketTraceFilename;
...
NrPhyRxTrace::~NrPhyRxTrace()
{
    ...
    if (m_ulrxPacketTraceFile.is_open())
    {
        m_ulrxPacketTraceFile.close();
    }
...
void
NrPhyRxTrace::SetResultPath(const std::string& path)
{
    m_path = path;
}
                                 ...
                                 uint8_t streamId)
{
    ...
    if (!m_dlDataSinrFile.is_open())
    {
        ...
        oss << m_resultsFolder << m_simTag.c_str() << "DlDataSinr" << ".txt";
                                 ...
                                 uint8_t streamId)
{
    ...
    {
        std::ostringstream oss;
        oss << m_resultsFolder << m_simTag.c_str() << "DlCtrlSinr" << ".txt";
                                         ...
                                         Ptr<const NrControlMessage> msg)
{
    ...
    {
        std::ostringstream oss;
        oss << m_resultsFolder << m_simTag.c_str() << "RxedGnbPhyCtrlMsgsTrace" << ".txt";
                                         ...
                                         Ptr<const NrControlMessage> msg)
{
    ...
    {
        std::ostringstream oss;
        oss << m_resultsFolder <<  m_simTag.c_str() << "TxedGnbPhyCtrlMsgsTrace" << ".txt";
                                        ...
                                        Ptr<const NrControlMessage> msg)
{
    ...
    {
        std::ostringstream oss;
        oss << m_resultsFolder << m_simTag.c_str() << "RxedUePhyCtrlMsgsTrace" << ".txt";
                                        ...
                                        Ptr<const NrControlMessage> msg)
{
    ...
    {
        std::ostringstream oss;
        oss << m_resultsFolder <<  m_simTag.c_str() << "TxedUePhyCtrlMsgsTrace" << ".txt";
                                     ...
                                     uint32_t k1Delay)
{
    ...
    {
        std::ostringstream oss;
        oss << m_resultsFolder << m_simTag.c_str() << "RxedUePhyDlDciTrace" << ".txt";
                                      ...
                                      RxPacketTraceParams params)
{
    ...
    {
        std::ostringstream oss;
        oss << m_resultsFolder << m_simTag.c_str() << "DlRxPacketTrace" << ".txt";
    ...
    m_rxPacketTraceFile << Simulator::Now().GetNanoSeconds() / (double)1e9 << "\t"
                        ...
                        << "\t" << (unsigned)params.m_numSym << "\t" << params.m_rbAssignedNum <<"\t" << params.m_cellId << "\t"
    ...
    if (params.m_corrupt)
    {
        NS_LOG_DEBUG("DL TB error\t"
                     << params.m_frameNum << "\t" << (unsigned)params.m_subframeNum << "\t"
                     << (unsigned)params.m_slotNum << "\t" << (unsigned)params.m_symStart << "\t"
                     << (unsigned)params.m_numSym  << "\t" << params.m_rbAssignedNum
                     << "\t" << params.m_rnti << "\t"
                     << params.m_tbSize << "\t" << (unsigned)params.m_mcs << "\t"
                                       ...
                                       RxPacketTraceParams params)
{
    ...
    {
        std::ostringstream oss;
        oss << m_resultsFolder << m_simTag.c_str() << "UlRxPacketTrace" << ".txt";
        m_ulrxPacketTraceFilename = oss.str();
        m_ulrxPacketTraceFile.open(m_ulrxPacketTraceFilename.c_str());

        m_ulrxPacketTraceFile << "Time"
                            << "\t"
                            << "direction"
                            << "\t"
                            << "frame"
    ...
    // std::cout <<"Packet Trace Function is called" <<std::endl;
    m_ulrxPacketTraceFile << Simulator::Now().GetNanoSeconds() / (double)1e9 << "\t"
                        << "UL"
                        << "\t" << params.m_frameNum << "\t" << (unsigned)params.m_subframeNum
                        << "\t" << (unsigned)params.m_slotNum << "\t" << (unsigned)params.m_symStart
                        << "\t" << (unsigned)params.m_numSym <<"\t" << params.m_rbAssignedNum << "\t" << params.m_cellId << "\t"
    ...
    if (params.m_corrupt)
    {
        NS_LOG_DEBUG("UL TB error\t"
                     << params.m_frameNum << "\t" << (unsigned)params.m_subframeNum << "\t"
                     << (unsigned)params.m_slotNum << "\t" << (unsigned)params.m_symStart << "\t"
                     << (unsigned)params.m_numSym << "\t" << params.m_rbAssignedNum << "\t" << params.m_rnti << "\t"
                     << params.m_tbSize << "\t" << (unsigned)params.m_mcs << "\t"
                                   ...
                                   double lossDb)
{
    ...
    {
        std::ostringstream oss;
        oss << m_resultsFolder << m_simTag.c_str() << "DlPathlossTrace" << ".txt";
                                   ...
                                   double lossDb)
{
    ...
    {
        std::ostringstream oss;
        oss << m_resultsFolder << m_simTag.c_str() << "UlPathlossTrace" << ".txt";
                                   ...
                                   double lossDb)
{
    ...
    {
        std::ostringstream oss;
        oss << m_resultsFolder << m_simTag.c_str() << "DlCtrlPathlossTrace" << ".txt";
                                   ...
                                   uint8_t cqi)
{
    ...
    {
        std::ostringstream oss;
        oss << m_resultsFolder << m_simTag.c_str() << "DlDataPathlossTrace" << ".txt";
