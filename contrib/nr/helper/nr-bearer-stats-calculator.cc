...
void 
NrBearerStatsCalculator::SetResultPath (std::string path)
{
    m_path = path;
}
...
void
NrBearerStatsCalculator::UlTxPdu(uint16_t cellId,
                                 uint64_t imsi,
                                 uint16_t rnti,
                                 uint8_t lcid,
                                 uint32_t packetSize)
...
void
NrBearerStatsCalculator::DlTxPdu(uint16_t cellId,
                                 uint64_t imsi,
                                 uint16_t rnti,
                                 uint8_t lcid,
                                 uint32_t packetSize)
...
void
NrBearerStatsCalculator::UlRxPdu(uint16_t cellId,
                                 uint64_t imsi,
                                 uint16_t rnti,
                                 uint8_t lcid,
                                 uint32_t packetSize,
...
void
NrBearerStatsCalculator::DlRxPdu(uint16_t cellId,
                                 uint64_t imsi,
                                 uint16_t rnti,
                                 uint8_t lcid,
                                 uint32_t packetSize,
...
NrBearerStatsCalculator::EndEpoch()
{
    ...
    m_endEpochEvent =
        Simulator::Schedule(m_epochDuration, &NrBearerStatsCalculator::EndEpoch, this);
}
