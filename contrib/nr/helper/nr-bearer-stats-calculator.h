...
#ifndef NR_RADIO_BEARER_STATS_CALCULATOR_H_
#define NR_RADIO_BEARER_STATS_CALCULATOR_H_
...
class NrBearerStatsCalculator : public NrBearerStatsBase
{
  ...
  private:
     ...
     */
    std::string m_dlRlcOutputFilename;
    /**
     * Name of the file where the uplink PDCP statistics will be saved
     */
    std::string m_ulRlcOutputFilename;
    /**
     * Name of the file where the downlink PDCP statistics will be saved
     */
...
#endif /* NR_RADIO_BEARER_STATS_CALCULATOR_H_ */
