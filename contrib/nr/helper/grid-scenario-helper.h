...
class GridScenarioHelper : public NodeDistributionScenarioInterface
{
  public:
    ...
    void SetPositionResetTime(uint16_t positionResetTime);
    ...
    void CreateRandomResetScenario();

    void ResetUePosition();

    void CreateFixedPositionScenario(Ptr<ListPositionAllocator> uePosition);
  ...
  private:
    ...
    uint16_t m_positionResetTime = 10;
};
