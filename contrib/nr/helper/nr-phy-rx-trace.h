...
class NrPhyRxTrace : public Object
{
  public:
    ...
    /**
     * \brief Set path
     * \param path string to be used as folder tag
     */
  ...
  private:
    ...
    static std::ofstream m_ulrxPacketTraceFile;
    static std::string m_ulrxPacketTraceFilename;
    ...
    std::string m_path; //change by Sangwon
};
