...
main(int argc, char* argv[])
{
    ...
    Time simTime = MilliSeconds(16000400);//1600400= 1million simtime for 8ms case = 800 second. 2ms case = 200 second (160400)
    ...
    double bandwidthBand2 = 100e6; // 100MHz for single and 20MHz for 10 UEs
