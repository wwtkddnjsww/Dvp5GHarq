 ...
 *
 * Details in the class NrMacSchedulerUeInfoEdf.
 *
 */
class NrMacSchedulerOfdmaEdf : public NrMacSchedulerOfdmaRR
{
  public:
    /**
     * \brief GetTypeId
    ...
    /**
     * \brief NrMacSchedulerOfdmaEdf constructor
     */
    NrMacSchedulerOfdmaEdf();

    /**
     * \brief ~NrMacSchedulerOfdmaEdf deconstructor
     */
    ~NrMacSchedulerOfdmaEdf() override
    {
    }
  ...
  protected:
    // inherit
    /**
     * \brief Create an UE representation of the type NrMacSchedulerUeInfoEdf
     ...
     * \return a pointer to NrMacSchedulerUeInfoEdf::CompareUeWeightsDl
     */
     ...
     * \return a pointer to NrMacSchedulerUeInfoEdf::CompareUeWeightsUl
     */
    std::function<bool(const NrMacSchedulerNs3::UePtrAndBufferReq& lhs,
                       const NrMacSchedulerNs3::UePtrAndBufferReq& rhs)>
     ...
     * by calling the NrMacSchedulerUeInfoEdf::UpdateDlQosMetric, which in turn will
    ...
    /**
     * \brief Update DL metrics by calling NrMacSchedulerUeInfoEdf::UpdateQosDlMetric
     ...
     * by calling the NrMacSchedulerUeInfoEdf::UpdateUlQosMetric, which in turn will
    ...
    /**
     * \brief Update UL metrics by calling NrMacSchedulerUeInfoEdf::UpdateQosUlMetric
     * \param ue UE to update (ue that didn't get any resources)
     * \param notAssigned the amount of resources not assigned
     * \param totAssigned the total amount of resources assigned in the slot
     *
     ...
     * NrMacSchedulerUeInfoEdf::CalculatePotentialTPutDl.
     */
     ...
     *
     * Calculates the the potential throughput by calling
     * NrMacSchedulerUeInfoEdf::CalculatePotentialTPutUl.
     */
  ...
  private:
    ...
    double m_alpha{1.0}; //!< PF Fairness index
};
