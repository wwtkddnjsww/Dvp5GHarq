...
NS_LOG_COMPONENT_DEFINE("NrMacSchedulerUeInfoEdf");

void
NrMacSchedulerUeInfoEdf::UpdateDlQosMetric(const NrMacSchedulerNs3::FTResources& totAssigned,
                                           double timeWindow,
...
void
NrMacSchedulerUeInfoEdf::UpdateUlQosMetric(const NrMacSchedulerNs3::FTResources& totAssigned,
                                           double timeWindow,
                                           const Ptr<const NrAmc>& amc)
{
    NS_LOG_FUNCTION(this);
