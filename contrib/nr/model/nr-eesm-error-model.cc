                                              ...
                                              const NrErrorModelHistory& sinrHistory)
{
    ...
    NS_LOG_DEBUG(" mcs " << +mcs << " TBSize in bit " << sizeBit << " history elements: "
                         ...
                         << "SINR: " << sinr);
    // std::cout << " mcs " << +mcs << " TBSize in bit " << sizeBit << " history elements: "
    //           << sinrHistory.size() << " SINR of the tx: " << tbSinr << std::endl;
            //   << "MAP: " << PrintMap(map) << std::endl
            //   << "SINR: " << sinr << std::endl;
    ...
    // std::cout << "EESMErrorModel: TBS of " << B << " bits distributed in " << C << " CBs of " << K
    //           << " bits" << "with SINR " << SINR << " and error rate " << errorRate << std::endl;
