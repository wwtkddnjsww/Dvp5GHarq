...
TypeId
NrMacSchedulerLcRR::GetInstanceTypeId() const
{
    return NrMacSchedulerLcRR::GetTypeId();
}
                                    ...
                                    uint32_t tbs) const
{
    ...
    for (const auto& lcg : ueLCG)
    {
        ...
        {
            activeLc++;
            // //Probably Need to be changed by Sangwon
